<!-- resources/views/website/pages/courses_regular/regular_english.blade.php -->
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt--30">
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                ...
                                <div>
                                    We're excited to have you on this journey through the wonders of English,
                                    literacy,
                                    language, and literature. Whether you're just starting in KS1 or mastering
                                    advanced
                                    skills in KS5, this course will help you develop confidence in literacy,
                                    reading,
                                    writing, speaking, grammar, punctuation, and comprehension. Get ready to
                                    explore
                                    literature, refine your grammar, and unleash your creativity!
                                </div>
                            </div>
