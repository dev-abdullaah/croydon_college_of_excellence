<!-- resources/views/website/pages/courses_regular/regular_ielts.blade.php -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <h2 class="title">IELTS Preparation Courses</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                                <div class="rbt-course-feature-inner radius-10">
                                    <div class="section-title">
                                        <h3 class="title mb--20">Welcome to the IELTS Preparation Course at CCE!</h3>
                                    </div>
                                    <div>
                                        We're excited to have you on board for our <span class="txt-highlight">IELTS
                                            Preparation Course!</span> Whether you're
                                        aiming for higher education, career advancement, or immigration purposes, this
                                        course is
                                        designed to give you the skills and confidence you need to succeed in the <span
                                            class="txt-highlight">International English
                                            Language Testing System (IELTS)</span> exam.
                                    </div>
                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li>
                                                ...
                                                <strong>Basic IELTS&nbsp;:&nbsp;</strong>
                                                Academic & GT
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>IELTS Regular&nbsp;:&nbsp;</strong>
                                                Academic & GT
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>IELTS Crash Course&nbsp;:&nbsp;</strong>
                                                Academic & GT
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="thumbnail">
                                        <img src="{{ asset('assets/images/course/ielts_course.png') }}" style="height: 200px!important; border-radius: 10px;">
                                    </div>
                                </div>
