<!-- resources/views/website/pages/courses_regular/regular_sat.blade.php -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title">SATs Course Preparation / Year 6</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                <div class="section-title">
                                    <h3 class="title mb--20">Welcome to the SATs Course Preparation at CCE - Year 6!
                                    </h3>
                                </div>
                                <div>
                                    We're excited to have you join our Year 6 SATs preparation course! This is a
                                    crucial time for
                                    you as you prepare for your <span class="txt-highlight">Key
                                        Stage 2 SATs exams</span> in <span class="txt-highlight">English</span> and
                                    <span class="txt-highlight">Mathematics</span>, and we're
                                ...
                                <div class="content">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        <li>
                                            ...
                                            Reading comprehension, grammar, punctuation, spelling, and writing
                                            skills.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>Mathematics&nbsp;:&nbsp;</strong>
                                            Arithmetic, geometry, fractions, decimals, and problem-solving.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>Exam&nbsp;Techniques&nbsp;:&nbsp;</strong>
                                            Time management, answering strategies, and mock tests to ensure you feel
                                            prepared.
                                        </li>
                                    </ul>
                                </div>
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/course/sat_course.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
                            ...
                            <div class="rbt-course-feature-inner mt-4 text-start">
                                Through interactive lessons, practice tests, and expert support, you'll be ready to
                                tackle the SATs with confidence and achieve great results!
                            </div>

                            <div class="rbt-course-feature-inner mt-4 mb-4 text-start">
                                Let's dive in and make your SAT prep journey a triumph. You've got everything it
                                takes to succeed!
                            </div>
