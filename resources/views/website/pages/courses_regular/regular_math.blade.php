<!-- resources/views/website/pages/courses_regular/regular_math.blade.php -->
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                <div class="section-title">
                                    <h3 class="title mb--20">Welcome to Our Math Courses (KS1 - KS5)!</h3>
                                </div>
                                <div>
                                    We're delighted to have you on board for an exciting journey through the world
                                    of mathematics! From building strong number foundations in KS1 to tackling
                                    advanced problem-solving in KS5, this course will help you develop confidence,
                                    logical thinking, and essential Maths skills.
                                </div>
                            </div>

                            <div class="rbt-course-feature-inner mt-4 text-start">
                                Get ready to explore patterns, puzzles, and real-world applications—let's make Maths fun and rewarding!
                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        <li>
                                            ...
                                            <strong>KS1&nbsp;:&nbsp;</strong>
                                            Number & Place Value, Addition, Subtraction, Multiplication, Division, Fractions, Measurement, Geometry & Statistics.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS2&nbsp;:&nbsp;</strong>
                                            Number & Place Value, Addition, Subtraction, Multiplication, Division, Fractions, Decimals, Percentages, Algebra, Ratio & Proportion, Measurement, Geometry & Statistics.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS3&nbsp;:&nbsp;</strong>
                                            Creative Reading, Creative Writing, Poetry, Fiction, Non-Fiction & Modern Plays.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS4&nbsp;:&nbsp;</strong>
                                            GCSE (Years 10 & 11) - Foundation & Higher Mathematics (AQA, Pearson, Eduqas).
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS5&nbsp;:&nbsp;</strong>
                                            A Level - Standard & Further Mathematics (AQA, Pearson, Eduqas).
                                        </li>
                                    </ul>
                                </div>
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/course/math_course.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
