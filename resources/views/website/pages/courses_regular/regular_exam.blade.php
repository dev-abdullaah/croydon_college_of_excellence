<!-- resources/views/website/pages/courses_regular/regular_exam.blade.php -->
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt--30">
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                ...
                                <div>
                                    We are thrilled to have you join us on this exciting journey as you prepare for
                                    the 11+ exams. Our course is designed to equip students with the knowledge,
                                    skills, and confidence needed to succeed in the entrance exams for top grammar
                            ...
                            <div class="inner mt--20">
                                ...
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/course/exam_11.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
