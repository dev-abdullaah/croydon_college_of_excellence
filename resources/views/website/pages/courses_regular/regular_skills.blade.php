<!-- resources/views/website/pages/courses_regular/regular_skills.blade.php -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title">Functional Skills Preparation Courses</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                <div class="section-title">
                                    <h3 class="title mb--20">Welcome to the Functional Skills Course at CCE!</h3>
                                </div>
                                <div>
                                    We're thrilled to welcome you to our <span class="txt-highlight">Functional
                                        Skills Course</span> -
                                    your pathway to mastering
                                    essential skills for life, work, and further education. Whether you're aiming to
                                    improve your <span class="txt-highlight">English</span> or
                                    <span class="txt-highlight">Mathematics</span> skills, this
                                    course is designed to build your confidence
                                    and practical
                                    knowledge, preparing you for success in everyday situations and the workplace.
                                    With our
                                    <span class="txt-highlight">interactive lessons, hands-on practice</span>, and
                                    <span class="txt-highlight">support from expert tutors</span>, you'll
                                    gain the skills you need to
                                    pass your Functional Skills assessments and achieve your goals.
                                </div>
                            </div>
                            ...
                            <div class="inner mt--20">
                                ...
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/course/functional_skill.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
