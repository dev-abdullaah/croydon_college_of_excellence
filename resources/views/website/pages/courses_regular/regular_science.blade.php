<!-- resources/views/website/pages/courses_regular/regular_science.blade.php -->
@extends('website.layouts.master')

@section('content')


<!-- Course Heading Starts-->
<div class="rbt-page-banner-wrapper">
    ...
    <div class="rbt-banner-content">
        ...
        <!-- Start Course Top  -->
        <div class="rbt-course-top-wrapper mt--40" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important;">
            <div class="container">
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt--30">
                                <div
                                    ...
                                    <div class="rbt-course-feature-inner radius-10">
                                        ...
                                        <div>
                                            We're excited to have you embark on a fascinating journey through
                                            science! From discovering the wonders of nature in KS1 to exploring
                                            advanced scientific concepts in KS5, this course will spark curiosity,
                                            develop critical thinking and build a strong foundation in
                                            <span class="txt-highlight">Physics</span>.
                                        </div>
                                    </div>

                                    <div class="rbt-course-feature-inner mt-4 text-start">
                                        Get ready for exciting experiments, real-world applications, and deep
                                        scientific exploration. Let's uncover the mysteries of the universe
                                        together!
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="rbt-course-feature-inner radius-10">
                                        ...
                                        <div>
                                            ...
                                            advanced scientific concepts in KS5, this course will spark curiosity,
                                            develop critical thinking, and build a strong foundation in
                                            <span class="txt-highlight">Chemistry</span>.
                                        </div>
                                    </div>
                                    <div class="rbt-course-feature-inner mt-4 text-start">
                                        Get ready for exciting experiments, real-world applications, and deep
                                ...
                                <div
                                    ...
                                    <div class="rbt-course-feature-inner radius-10">
                                        ...
                                        <div>
                                            ...
                                            advanced scientific concepts in KS5, this course will spark curiosity,
                                            develop critical thinking, and build a strong foundation in
                                            <span class="txt-highlight">Biology</span>.
                                        </div>
                                    </div>
                                    <div class="rbt-course-feature-inner mt-4 text-start">
                                        Get ready for exciting experiments, real-world applications, and deep
                                        ...
                                        <div class="content">
                                            ...
                                            <ul class="rbt-list-style-1">
                                                <li>
                                                    <i class="feather-check"></i>
                                                    <strong>KS1&nbsp;:&nbsp;</strong>
                                                    Living Things and Their Habitats, Animals (Including Humans), Plants & Seasonal Changes.
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i>
                                                    <strong>KS2&nbsp;:&nbsp;</strong>
                                                    Living Things and Their Habitats, Animals (Including Humans), Plants & Seasonal Changes, Life Cycles & Evolution, and Inheritance (Year 6).
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i>
                                                    <strong>KS3&nbsp;:&nbsp;</strong>
                                                    Cells and Organization, The Human Body, Health and Disease, Reproduction and Inheritance, Ecology and the Environment, Plant Biology and Photosynthesis, Evolution and Adaptation.
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i>
                                                    <strong>KS4&nbsp;:&nbsp;</strong>
                                                    GCSE (Years 10 & 11) - Paper 1 & Paper 2 (AQA, Pearson, Eduqas, OCR).
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i>
                                                    <strong>KS5&nbsp;:&nbsp;</strong>
