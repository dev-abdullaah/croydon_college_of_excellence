<!-- resources/views/website/pages/courses_send/send_math.blade.php -->
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                ...
                                <div>
                                    ...
                                    committed to providing <span class="txt-highlight">specialized
                                        support for students with Special Educational Needs (SEN)</span> in
                                    Mathematics, from <span class="txt-highlight">Key Stage 1 to Key Stage 5</span>.
                                    Our expert tutors create a <span class="txt-highlight">structured, patient, and
                                        encouraging learning environment</span> to help every
                                    student build confidence and succeed!
                                </div>
                            </div>

                            <div class="rbt-course-feature-inner mt-4 text-start txt-red">
                                <strong>
                                    ***Get ready to explore patterns, puzzles, and real-world applications—let's
                                    make Maths fun and rewarding!***
                                </strong>
                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        ...
                                        <li>
                                            ...
                                            <strong>KS2&nbsp;:&nbsp;</strong>
                                            Number & Place Value, Addition, Subtraction, Multiplication, Division,
                                            Fractions, Decimals, Percentages, Algebra, Ratio & Proportion,
                                            Measurement, Geometry & Statistics.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS3&nbsp;:&nbsp;</strong>
                                            Creative Reading, Creative Writing, Poetry, Fiction, Non-Fiction &
                                            Modern Plays.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS4&nbsp;:&nbsp;</strong>
                                            GCSE (Years 10 & 11) - Foundation & Higher Mathematics (AQA, Pearson,
                                            Eduqas).
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
