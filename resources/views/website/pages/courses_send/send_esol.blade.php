<!-- resources/views/website/pages/courses_send/send_esol.blade.php -->
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                ...
                                <div>
                                    ...
                                    provide a <span class="txt-highlight">supportive and engaging learning
                                        environment</span>
                                    for students with <span class="txt-highlight">Special Educational Needs
                                        (SEN)</span> who are learning <span class="txt-highlight">English as a
                                        Second or Other Language (ESOL)</span>. Our tailored approach helps learners
                                    <span class="txt-highlight">build confidence, improve communication, and develop
                                        essential language skills</span> for daily life, education, and work.
                                </div>
                            </div>

                            <div class="rbt-course-feature-inner mt-4 text-start txt-red">
                                <strong>
                                    ***Helping Every Learner Communicate, Connect & Succeed in English!***
                                </strong>
                            </div>
                            ...
                            <div class="inner mt--20">
                                ...
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/course/esol_course.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
