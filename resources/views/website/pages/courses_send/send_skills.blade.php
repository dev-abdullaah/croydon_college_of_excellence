<!-- resources/views/website/pages/courses_send/send_skills.blade.php -->
                            ...
                            <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                                <div class="rbt-course-feature-inner radius-10">
                                    ...
                                    <div>
                                        ...
                                        with <span class="txt-highlight">Special
                                            Educational Needs (SEN)</span> develop essential skills in <span
                                            class="txt-highlight">English & Math</span>, for everyday
                                        life, work,
                                        and further education. Our <span class="txt-highlight">Functional Skills
                                            Course</span> provides a <span class="txt-highlight">supportive,
                                            structured, and
                                            engaging</span> learning experience tailored to individual needs.
                                    </div>
                                </div>

                                <div class="rbt-course-feature-inner mt-4 text-start txt-red">
                                    <strong>
                                        ***Empowering Every Learner with Essential Skills for Life & Success!***
                                    </strong>
                                </div>
