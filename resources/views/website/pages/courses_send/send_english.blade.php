<!-- resources/views/website/pages/courses_send/send_english.blade.php -->
                            ...
                            <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                                <div class="rbt-course-feature-inner radius-10">
                                    <div class="section-title">
                                        <h3 class="title mb--20">Welcome to Our UK English Course (KS1 - KS5)!</h3>
                                    </div>
                                    <div>
                                        At <span class="txt-highlight">Croydon College of Excellence</span>, we are
                                        dedicated to providing <span class="txt-highlight">specialized
                                            support for students with Special Educational Needs (SEN)</span> in English,
                                        from <span class="txt-highlight">Key Stage 1 to
                                            Key Stage 5</span>. Our expert tutors are here to create a <span
                                            class="txt-highlight">nurturing, inclusive, and engaging
                                            learning environment</span> to help every child thrive
                                    </div>
                                </div>

                                <div class="rbt-course-feature-inner mt-4 text-start">
                                    <h4><strong>Let's make learning English engaging and fun—welcome
                                            aboard!</strong></h4>
                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li>
                                                ...
                                                <strong>KS1&nbsp;:&nbsp;</strong>
                                                Phonics and Letter Recognition, Reading Comprehension and Story
                                                Sequencing, Spelling, Handwriting, Sentence Construction, Basic Grammar
                                                (Punctuation, Adjectives, Verbs), and Speaking & Listening Skills
                                                (Including Sharing Ideas and Responding to Others).
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>KS2&nbsp;:&nbsp;</strong>
                                                Spelling, Punctuation & Grammar (SPaG), Comprehension and Interpretation
                                                of Texts, Creative and Persuasive Writing, and Communication Through
                                                Speaking & Listening.
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>KS3&nbsp;:&nbsp;</strong>
                                                Creative Reading and Writing, Poetry, Fiction, Non-Fiction, and Modern
                                                Plays.
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>KS4&nbsp;:&nbsp;</strong>
                                                GCSE (Years 10 & 11) - Language & Literature (AQA, Pearson, Eduqas).
                                            </li>
                                            <li>
                                                <i class="feather-check"></i>
                                                <strong>KS5&nbsp;:&nbsp;</strong>
                                                A Level (Language & Literature - AQA, Pearson, Eduqas).
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="thumbnail">
                                        <img src="{{ asset('assets/images/course/english_course.png') }}" style="height: 200px!important; border-radius: 10px;">
                                    </div>
                                </div>
