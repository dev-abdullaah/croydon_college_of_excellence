<!-- resources/views/website/pages/courses_send/send_exam.blade.php -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title">11+ Exam Preparation</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                <div class="section-title">
                                    <h3 class="title mb--20">Welcome to the 11+ Course at CCE!</h3>
                                </div>
                                <div>
                                    At <span class="txt-highlight"> Croydon College of Excellence (CCE)</span>, we
                                    specialize in <span class="txt-highlight">11+ exam preparation</span> for
                                    students with <span class="txt-highlight">Special Educational Needs
                                        (SEN)</span>. Our
                                    expert tutors provide a <span class="txt-highlight">structured, supportive,
                                        and confidence-boosting</span> learning environment tailored to each child's
                                    unique abilities.
                                </div>
                            </div>
                            ...
                            <div class="rbt-course-feature-inner mt-4 text-start txt-red">
                                <strong>
                                    ***Building Confidence, Skills & Success for 11+ Entrance Exams!***
                                </strong>
                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        <li>
                                            ...
                                            Problem-solving, arithmetic, and algebra.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                        ...
                                        <li>
                                            ...
                                            Logical thinking, vocabulary, and understanding patterns.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>Non-Verbal Reasoning&nbsp;:&nbsp;</strong>
                                            Visual puzzles and pattern recognition.
                                        </li>
                                    </ul>
                                </div>
                                <div class="thumbnail">
                                    <img src="{{ ('assets/images/course/exam_11.png') }}" style="height: 200px!important; border-radius: 10px;">
                                </div>
                            </div>
                            ...
                            <div class="rbt-course-feature-inner mt-4 text-start">
                                With our <span class="txt-highlight">interactive lessons,
                                    practice papers,</span> and <span class="txt-highlight">expert guidance,</span>
                                you'll
                                feel
                                ready and confident to tackle the 11+ exam!
                            </div>

                            <div class="rbt-course-feature-inner mt-4 mb-4 text-start">
                                Let's get started and make this an enjoyable and successful learning experience!
                            </div>
