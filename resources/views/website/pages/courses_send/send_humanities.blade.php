<!-- resources/views/website/pages/courses_send/send_humanities.blade.php -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title">Humanities Course Preparation</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="rbt-service rbt-service-2 variation-2 color-box bg-color-white-off radius-10">
                            <div class="rbt-course-feature-inner radius-10">
                                <div>
                                    ...
                                    are proud to offer <span class="txt-highlight">Special
                                        Educational Needs (SEN)</span> support
                                    in the Humanities for students from <span class="txt-highlight">Key Stage
                                        1 to Key Stage 5</span>. Our goal is to make <span
                                        class="txt-highlight">History,
                                        Geography, and Social Studies</span> accessible, engaging, and rewarding for
                                    every learner, regardless of their individual needs.
                                </div>
                            </div>

                            <div class="rbt-course-feature-inner mt-4 text-start txt-red">
                                <strong>
                                    ***Helping Every Student Explore, Understand, and Succeed in Humanities!***
                                </strong>
                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        <li>
                                            ...
                                            <strong>KS1&nbsp;:&nbsp;</strong>
                                            Introduction to History, Basic Geography, Basic Social Studies.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS2&nbsp;:&nbsp;</strong>
                                        ...
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS3&nbsp;:&nbsp;</strong>
                                            History, Geography, Citizenship & Social Studies.
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS4&nbsp;:&nbsp;</strong>
                                            GCSE/Yr. 10 & 11 (Paper 1 & Paper 2 or Paper 3 - AQA, Pearson, Eduqas, &
                                            OCR).
                                        </li>
                                        <li>
                                            <i class="feather-check"></i>
                                            <strong>KS5&nbsp;:&nbsp;</strong>
                                            A Level (Paper 1, 2 & 3 - AQA, Pearson, Eduqas & OCR).
                                        </li>
                                    </ul>
                                </div>
                                <div class="thumbnail">
