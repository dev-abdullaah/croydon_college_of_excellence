            ...
            <div class="row row--15 mt_dec--30">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="footer-widget">
                        ...
                        <p
                            style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 15px !important; font-weight: bold; margin-top: 10px;">
                            Excel Your Knowledge
                            <br>
                            Drive Your Career
                        </p>

                        <div class="contact-btn mt--30">
                            <a class="rbt-btn hover-icon-reverse btn-border-gradient radius-round" href="{{ url('/contact-us') }}">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="footer-widget">
                        <h5 class="ft-title">Our Institution</h5>
                        <ul class="ft-link">
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/our-mission') }}">Our Mission & Vision</a>
                            </li>
                            <li>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                <p class="rbt-link-hover text-center text-lg-start">Copyright © <span id="year"></span> <a
                        href="https://croydoncollegeofexcellence.co.uk">Croydon College of Excellence.</a> All
                    rights reserved.</p>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                <ul
